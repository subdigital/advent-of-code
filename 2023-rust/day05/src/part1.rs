...
use nom::{character::complete::{space1, self, line_ending}, multi::{separated_list1, fold_many1, many1}, sequence::{preceded, terminated, tuple}, bytes::complete::{tag, take_until}, IResult, combinator::eof, branch::alt};
...
pub fn process(input: &str) -> String {
    ...
    println!("Source maps parsed: {:?}", source_maps.keys());
